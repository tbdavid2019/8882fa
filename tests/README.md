...
| 国际化 (i18n)    | 多语言字典完整性、浏览器语言解析、DOM 动态翻译、日期与字串排序                  | [i18n.test.js](scripts/i18n.test.js)                                                                                                                                                                                                                                                                               |
| 部署与构建       | 部署配置、发布构建                                                              | [deploy-config.test.js](scripts/deploy-config.test.js)、[build-release-code.test.js](scripts/build-release-code.test.js)                                                                                                                                                                                           |
