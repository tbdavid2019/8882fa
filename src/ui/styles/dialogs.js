...
export function getDialogStyles() {
    ...
    .modal, .center-toast, .dialog-toast {
      ...
      --dialog-surface: #fffdfa;
      --dialog-subtle: #f7f4ef;
      --dialog-hover: #eee8df;
      --dialog-text: #302820;
      --dialog-muted: #675b50;
      --dialog-line: #e4dbd0;
      --dialog-stroke: #cfc2b4;
      --dialog-brand: #76543f;
      --dialog-brand-hover: #61432f;
      --dialog-selected: #efe5da;
      ...
      --btn-primary-bg: var(--dialog-brand);
      --btn-primary-hover: var(--dialog-brand-hover);
    ...
    [data-theme="dark"] .modal, [data-theme="dark"] .center-toast, [data-theme="dark"] .dialog-toast {
      --dialog-surface: #2b2521;
      --dialog-subtle: #211d1a;
      --dialog-hover: #3a312b;
      --dialog-text: #f4eee8;
      --dialog-muted: #c7b9ad;
      --dialog-line: #4a3e35;
      --dialog-stroke: #756254;
      --dialog-brand: #d5b49a;
      --dialog-brand-hover: #e7cdb7;
      --dialog-selected: #49382d;
